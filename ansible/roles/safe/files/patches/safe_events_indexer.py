...
# from safe-transaction-service v5.40.1 (image pinned by digest in defaults/main.yml).
...
# transfers on event-indexed/L2 networks). Bind-mounted over the original by
# docker-compose. MUST be regenerated when safe_txs_version changes.
import datetime
