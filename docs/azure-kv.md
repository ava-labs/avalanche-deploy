...
> **✅ Validated**: this backend passed the full [end-to-end suite](e2e.md)
> against a real Azure Key Vault (RBAC mode, VM managed identity) on
> 2026-07-16 — `keytool generate` → signer → live avalanchego → warp + PoP
