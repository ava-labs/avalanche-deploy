...
## Troubleshooting
- "use of internal package not allowed" → the importer lives outside this module. `internal/` is only reachable from within `github.com/ava-labs/avalanche-deploy/tools/remote-signer`; copy the code or move it out of `internal/` if it must be shared externally.
