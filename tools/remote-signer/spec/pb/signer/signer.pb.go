...
const file_signer_proto_rawDesc = "" +
	...
	"\x15SignProofOfPossession\x12$.signer.SignProofOfPossessionRequest\x1a%.signer.SignProofOfPossessionResponse\"\x00BIZGgithub.com/ava-labs/avalanche-deploy/tools/remote-signer/spec/pb/signerb\x06proto3"
